...
print("Fibonacci number 42: " + fib(42))
```
...
for i in range(len(uniq)):
    indx = iris['Species'] == uniq[i]
    plt.scatter(iris["Sepal.Width"][indx], iris["Sepal.Length"][indx], s=15, color=scalarMap.to_rgba(i), label=uniq[i])
```
